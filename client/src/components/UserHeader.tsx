...
const UserHeader = () => {
  ...
  return (
    <>
      <div className="w-full h-[72px] px-[12.5%] bg-white flex justify-center">
          <div className="bg-white w-[1120px] h-full flex justify-between items-center">
            <div className="flex items-center gap-20">
              <div className="flex gap-16 items-center">
                <div className="mr-5 text-3xl font-serif cursor-pointer" onClick={()=>{
                  navigate("/");
                }}>JobLelo</div>
                <div>Jobs</div>
                <div>Companies</div>
              ...
              >
                ...
                />
                <button className="text-white text-[20px] bg-blue-600 rounded-full p-1 cursor-pointer">
                  <IoSearch />
                </button>
              </div>
            </div>
